  ...
  <div class="h-screen bg-slate-50 flex">
      ...
      <div class="flex-1 flex flex-col">
        ...
        <div v-else class="flex-1 flex items-center justify-center">
          <div class="text-center">
            <h2 class="text-2xl font-semibold text-gray-900 mb-2">{{ currentView.charAt(0).toUpperCase() + currentView.slice(1) }}</h2>
            <p class="text-gray-500">This view is not implemented yet.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div v-else class="w-full">
      ...
      <div class="bg-white border-b border-gray-200 px-4 py-3">
        <div class="flex items-center justify-between">
          ...
          <button @click="toggleUserType" class="text-sm text-slate-600 hover:text-slate-800">
        ...
        <div v-else>
          <div class="bg-white rounded-lg shadow-sm">
            <div class="p-4 border-b border-gray-200">
              <h2 class="text-lg font-semibold text-gray-900">Expenses Overview</h2>
            </div>
            <div class="p-4">
    ...
    <div class="fixed bottom-4 right-4 z-50">
      <div class="bg-white rounded-lg shadow-lg border border-gray-200 p-3">
        <div class="text-xs text-gray-500 mb-2">Demo Controls</div>
        <div class="flex flex-col space-y-2">
          ...
          <button 
            @click="toggleUserType"
            class="text-xs bg-emerald-100 hover:bg-emerald-200 text-slate-700 px-3 py-1 rounded"
          >
