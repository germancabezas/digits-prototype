      ...
      <div class="px-6 py-4 border-b border-gray-200">
        <div class="flex items-center justify-between relative">
          <div>
            ...
            <span class="text-sm ml-6 text-emerald-600">AI generated categories: 70% + confidence</span>
          </div>
          <ExpenseFilters
        ...
        <table class="min-w-full divide-y divide-gray-200">
          <thead class="bg-gray-50">
            <tr>
              ...
              <th class="px-6 py-3 text-left text-xs font-medium text-emerald-600 uppercase tracking-wider ">AI Analysis</th>
          ...
          <tbody class="bg-white divide-y divide-gray-200">
            <tr v-for="transaction in needVerificationTransactions" :key="transaction.id" class="hover:bg-gray-50">
              ...
              <td>
                <div class="text-xs text-slate-600 px-6 py-3">
